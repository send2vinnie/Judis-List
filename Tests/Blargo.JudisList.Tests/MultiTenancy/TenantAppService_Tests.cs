...
namespace Blargo.JudisList.Tests.MultiTenancy
{
        ...
        public async Task Create_Update_And_Delete_Tenant_Test()
        {
            ...
            await _tenantAppService.CreateTenant(
                new CreateTenantInput
                {
                    ...
                    IsActive = true,
                    ConnectionString = "Server=localhost; Database=JudisListTest_" + Guid.NewGuid().ToString("N") + "; Trusted_Connection=True;"
                });
