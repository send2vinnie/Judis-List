...
using Blargo.JudisList.Organizations.Dto;
using System.Linq.Dynamic;

namespace Blargo.JudisList.Organizations
{
    [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits)]
    public class OrganizationUnitAppService : JudisListAppServiceBase, IOrganizationUnitAppService
    {
