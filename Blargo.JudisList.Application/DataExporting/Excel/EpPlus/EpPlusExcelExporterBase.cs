...
using Blargo.JudisList.Net.MimeTypes;
using OfficeOpenXml;

namespace Blargo.JudisList.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : JudisListServiceBase, ITransientDependency
    {
