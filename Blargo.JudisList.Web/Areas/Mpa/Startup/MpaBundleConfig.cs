...
namespace Blargo.JudisList.Web.Areas.Mpa.Startup
{
        ...
        private static void AddAppMetrinicCss(BundleCollection bundles, bool isRTL)
        {
            bundles.Add(
                new StyleBundle("~/Bundles/Mpa/metronic/css" + (isRTL ? "RTL" : ""))
                    ...
                    .Include("~/metronic/assets/admin/layout4/css/themes/default" + (isRTL ? "-rtl" : "") + ".css", new CssRewriteUrlWithVirtualDirectoryTransform())
                    .ForceOrdered()
                );
        }
    }
