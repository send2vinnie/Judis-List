...
using Blargo.JudisList.Authorization.Users.Profile;
using Blargo.JudisList.Timing;
using Blargo.JudisList.Timing.Dto;
using Blargo.JudisList.Web.Areas.Mpa.Models.Profile;
using Blargo.JudisList.Web.Controllers;

namespace Blargo.JudisList.Web.Areas.Mpa.Controllers
{
    [AbpMvcAuthorize]
    public class ProfileController : JudisListControllerBase
    {
