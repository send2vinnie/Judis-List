...
using Blargo.JudisList.Configuration.Host;
using Blargo.JudisList.Editions;
using Blargo.JudisList.Timing;
using Blargo.JudisList.Timing.Dto;
using Blargo.JudisList.Web.Areas.Mpa.Models.HostSettings;
...
namespace Blargo.JudisList.Web.Areas.Mpa.Controllers
{
    ...
    public class HostSettingsController : JudisListControllerBase
    {
