...
using Blargo.JudisList.Sessions;
using Blargo.JudisList.Web.Areas.Mpa.Models.Layout;
using Blargo.JudisList.Web.Areas.Mpa.Startup;
using Blargo.JudisList.Web.Controllers;
using Blargo.JudisList.Web.Models.Layout;
using Blargo.JudisList.Web.Session;
using HeaderViewModel = Blargo.JudisList.Web.Areas.Mpa.Models.Layout.HeaderViewModel;

namespace Blargo.JudisList.Web.Areas.Mpa.Controllers
{
    [AbpMvcAuthorize]
    public class LayoutController : JudisListControllerBase
    {
