...
using Blargo.JudisList.Web.Areas.Mpa.Startup;//MPA!
using Blargo.JudisList.Web.Bundling;
using Blargo.JudisList.Web.Navigation;
using Blargo.JudisList.Web.Routing;
using Blargo.JudisList.WebApi;
...
namespace Blargo.JudisList.Web
{
    ...
    [DependsOn(
        ...
        typeof(JudisListDataModule),
        typeof(JudisListApplicationModule),
        typeof(JudisListWebApiModule),
    ...
    public class JudisListWebModule : AbpModule
    {
