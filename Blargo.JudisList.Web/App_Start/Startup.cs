...
using Blargo.JudisList.Web;
using Blargo.JudisList.Web.Auth;
using Blargo.JudisList.WebApi.Controllers;
using Owin;
...
namespace Blargo.JudisList.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //Enable it to use HangFire dashboard (uncomment only if it's enabled in JudisListWebModule)
